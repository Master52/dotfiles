...
c.fonts.default_family = 'FanstasqueSansMono'

# Bindings for normal mode
config.bind('M', 'hint links spawn mpv {hint-url}')
config.bind('X', 'hint links spawn st -e youtube-dl -o ~/Music/%(title)s.%(ext)s --extract-audio --audio-format mp3 {hint-url}')
config.bind('x', "hint links spawn st -e youtube-dl -o ~/Videos/%(title)s.%(ext)s -f 'bestvideo=[ext=mp4]+bestaudio[ext=m4a]/bestvideo+bestaudio' --merge-output-format mp4 {hint-url}")
config.bind('z', 'spawn st -e wget -P /home/master/Downloads  -c {url}')
